...
The only difference with model_v1 is that it uses a weighted loss function that 
gives higher weights (15) to errors on breast masses compared to breast tissue
(1) encouraging the network to learn better features to correctly distinguish
lesions.
