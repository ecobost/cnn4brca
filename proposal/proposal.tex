...
\usepackage{hyperref}		% To manage \url
...
\proptitulo{Early detection and diagnosis of breast cancer lessions using (deep) convolutional neural networks in digital mammographic images.(working title)}	% Title
