...
\subsection{Resizing}
We downsample our images to hold a $2 \times 2$ cm area into $112 \times 112$ pixels---roughly a 2.5 factor.
...
The entire data set weights approximately 1.5 gigabytes.
