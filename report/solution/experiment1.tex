...
% The produced segmentation (a logit heatmap), is upsampled...
% It produces a heatmap of logits that is upsampled...
...
%Produced segmentations are 16 times smaller than the original images
% Produced segmentations are logits
...
Performance was calculated on the cross-validation set. Trained for 2 epochs on the data.
