...
% Images will not be zero-centered , normalized or whitened.
	...
	% Replacing the pooling layers by convolutional layers or overlapping pooling could marginally improve results.
