...
% total # of parameters: 2 793 673
	...
	% Convolutional overlapping pooling. all convolutional networks do add a lot of params. i am wrong.
...
Other options: batch normalization (man, it appears to be good, speeds learning, no need to choose small learning rate, no need for dropout)
	...
	%Use leaky RELUs, ADAM and batch normalization for more advanced results
	% Dropout is important
	%0.1 learning rate divided by 2 when convergence
