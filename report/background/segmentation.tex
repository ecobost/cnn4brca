...
To evaluate the model, we measure a classification metric (Sec.~\ref{sec:Classification}) on segmentations produced for images in the test set and average the results. \emph{Pixel accuracy}, for instance, estimates the average proportion of correctly classified pixels in a segmentation; other metrics are calculated similarly.
